...
<dd></dd>
<dt><a href="#sliceCallback">sliceCallback</a> ⇒ <code><a href="#jLight">jLight</a></code></dt>
<dd></dd>
...
### CSS~addClass(cssClasses) ⇒ [<code>jLight</code>](#jLight)
...
<a name="module_ElementData..data"></a>
...
<a name="module_Manipulation..add"></a>
...
<a name="module_Manipulation..prependTo"></a>
...
### Manipulation~before($elements) ⇒ [<code>jLight</code>](#jLight)
...
### Selection~children() ⇒ [<code>jLight</code>](#jLight)
...
### Selection~not($elements) ⇒ [<code>jLight</code>](#jLight)
...
### ArrayLike~filter(callbackOrSelector) ⇒ [<code>jLight</code>](#jLight)
...
<a name="module_ArrayLike..splice"></a>
...
<a name="module_ArrayLike..lastIndexOf"></a>
...
### Animation~scrollTo($elements, [duration], [offset], [callback]) ⇒ [<code>jLight</code>](#jLight)
...
| Name | Type | Description |
| --- | --- | --- |
| elements | <code>Array.&lt;HTMLElement&gt;</code> | The collections elements. |
| length | <code>number</code> | The collections element count. |
| tagName | <code>string</code> | The collections first elements tag name. |
| addClass | [<code>cssClassCallback</code>](#cssClassCallback) | Adds css classes to the collections elements. |
| removeClass | [<code>cssClassCallback</code>](#cssClassCallback) | Removes css classes to the collections elements. |
| toggleClass | [<code>toggleCssClassCallback</code>](#toggleCssClassCallback) | Toggles css classes of the collections elements. |
| hasClass | [<code>hasClassCallback</code>](#hasClassCallback) | Whether at least one of the collections elements has all of the provided classes. |
| css | [<code>cssCallback</code>](#cssCallback) | Applies style rules to the collections elements, gets the current style rules or gets the current value for a specific style property. |
| show | [<code>visibilityCallback</code>](#visibilityCallback) | Shows the collections elements. |
| hide | [<code>defaultCallback</code>](#defaultCallback) | Hides the collections elements. |
| toggle | [<code>toggleVisibilityCallback</code>](#toggleVisibilityCallback) | Toggles the collections elements visibility. |
| on | [<code>onCallback</code>](#onCallback) | Adds event handlers to elements. |
| once | [<code>onCallback</code>](#onCallback) | Adds event handlers to elements fo one time execution. |
| off | [<code>offCallback</code>](#offCallback) | Removes event handlers from elements. |
| delegate | [<code>delegateCallback</code>](#delegateCallback) | [DEPRECATED] Delegates event handlers to elements. |
| undelegate | [<code>delegateCallback</code>](#delegateCallback) | [DEPRECATED] Undelegates event handlers from elements. |
| trigger | [<code>triggerCallback</code>](#triggerCallback) | Triggers events on the collections elements. |
| prop | [<code>propCallback</code>](#propCallback) | Sets a property of the collections elements or gets its value. |
| attr | [<code>attrCallback</code>](#attrCallback) | Sets an attribute or attributes to the collections elements or gets its value or values. |
| removeAttr | [<code>removeAttrCallback</code>](#removeAttrCallback) | Removes the supplied attributes from the collections elements. |
| text | [<code>contentCallback</code>](#contentCallback) | Gets or sets the text content of the collections elements. |
| html | [<code>contentCallback</code>](#contentCallback) | Gets or sets the HTML content of the collections elements. |
| val | [<code>valCallback</code>](#valCallback) | Gets or sets the collections elements values. |
| data | [<code>dataCallback</code>](#dataCallback) | Gets or sets the jLight data of the collections elements. |
| empty | [<code>defaultCallback</code>](#defaultCallback) | Empties the collections elements HTML content. |
| clone | [<code>cloneCallback</code>](#cloneCallback) | Clones the collection. |
| add | [<code>elementsCallback</code>](#elementsCallback) | Adds elements to the collection. |
| remove | [<code>removeCallback</code>](#removeCallback) | Removes elements from the collection. |
| prepend | [<code>elementsCallback</code>](#elementsCallback) | Prepends elements to the collections elements. |
| append | [<code>elementsCallback</code>](#elementsCallback) | Appends elements to the collections elements. |
| prependTo | [<code>elementsCallback</code>](#elementsCallback) | Prepends the collections elements to elements. |
| appendTo | [<code>elementsCallback</code>](#elementsCallback) | Appends the collections elements to elements. |
| insertBefore | [<code>elementsCallback</code>](#elementsCallback) | Inserts the collections elements before elements. |
| insertAfter | [<code>elementsCallback</code>](#elementsCallback) | Inserts the collections elements after elements. |
| before | [<code>elementsCallback</code>](#elementsCallback) | Inserts elements before the collections elements. |
| after | [<code>elementsCallback</code>](#elementsCallback) | Inserts elements after the collections elements. |
| wrap | [<code>elementsCallback</code>](#elementsCallback) | Wraps the collections elements in elements. |
| get | [<code>indexElementCallback</code>](#indexElementCallback) | Gets the element at the supplied index from the collection. |
| eq | [<code>indexjLightCallback</code>](#indexjLightCallback) | Gets the jLight element at the supplied index from the collection. |
| first | [<code>defaultCallback</code>](#defaultCallback) | Gets the first jLight element from the collection. |
| last | [<code>defaultCallback</code>](#defaultCallback) | Gets the last jLight element from the collection. |
| parent | [<code>defaultCallback</code>](#defaultCallback) | Gets a jLight collection from the collections parent elements. |
| parents | [<code>defaultCallback</code>](#defaultCallback) | Gets a jLight collection from all the collections parent elements. |
| children | [<code>defaultCallback</code>](#defaultCallback) | Gets a jLight collection from the collections children elements. |
| siblings | [<code>defaultCallback</code>](#defaultCallback) | Gets a jLight collection from the collections sibling elements. |
| prev | [<code>selectorCallback</code>](#selectorCallback) | Gets a jLight collection from the collections previous sibling elements. |
| next | [<code>selectorCallback</code>](#selectorCallback) | Gets a jLight collection from the collections next sibling elements. |
| closest | [<code>selectorCallback</code>](#selectorCallback) | Gets a jLight collection from all the collections parent elements matching the selector. |
| not | [<code>elementsCallback</code>](#elementsCallback) | Gets a jLight collection from the collections elements which are not part of elements. |
| has | [<code>elementsCallback</code>](#elementsCallback) | Gets a jLight collection from the collections elements which contain elements. |
| filter | [<code>filterCallback</code>](#filterCallback) | Gets a filtered jLight collection based on the input. |
| forEach | [<code>outerIteratorCallback</code>](#outerIteratorCallback) | Runs a function on each of the collections elements. |
| each | [<code>outerIteratorCallback</code>](#outerIteratorCallback) | [DEPRECATED] Runs a function on each of the collections elements. |
| slice | [<code>sliceCallback</code>](#sliceCallback) | Slices the collection. |
| splice | [<code>spliceCallback</code>](#spliceCallback) | Splices the collection. |
| push | [<code>arrayLengthCallback</code>](#arrayLengthCallback) | Pushes elements to the collection. |
| pop | [<code>defaultCallback</code>](#defaultCallback) | Pops the last element from the collection. |
| reverse | [<code>defaultCallback</code>](#defaultCallback) | Reverses a collection. |
| shift | [<code>defaultCallback</code>](#defaultCallback) | Shifts a collection. |
| unshift | [<code>arrayLengthCallback</code>](#arrayLengthCallback) | Unshifts a collection. |
| sort | [<code>sortCallback</code>](#sortCallback) | Sorts a collection. |
| reduce | [<code>reduceCallback</code>](#reduceCallback) | Reduces a collection. |
| map | [<code>mapCallback</code>](#mapCallback) | Maps a collection. |
| concat | [<code>multipleElementsCallback</code>](#multipleElementsCallback) | Concats a collection with other collections. |
| includes | [<code>elementsBooleanCallback</code>](#elementsBooleanCallback) | Whether the collections elements include at least one of elements. |
| some | [<code>arrayBooleanCallback</code>](#arrayBooleanCallback) | Whether at least one of the collections elements meets the conditon. |
| every | [<code>arrayBooleanCallback</code>](#arrayBooleanCallback) | Whether every one of the collections elements meets the conditon. |
| indexOf | [<code>elementsNumberCallback</code>](#elementsNumberCallback) | Gets the given elements index inside the collection. |
| lastIndexOf | [<code>elementsNumberCallback</code>](#elementsNumberCallback) | Gets the given elements last index inside the collection. |
| find | [<code>selectorCallback</code>](#selectorCallback) | Gets a jLight collection from the collections children elements matching the selector. |
| width | [<code>getOrSetValueCallback</code>](#getOrSetValueCallback) | Gets or sets the width of the collections elements. |
| height | [<code>getOrSetValueCallback</code>](#getOrSetValueCallback) | Gets or sets the height of the collections elements. |
| innerWidth | [<code>dimensionCallback</code>](#dimensionCallback) | Gets the inner width of the collections elements. |
| innerHeight | [<code>dimensionCallback</code>](#dimensionCallback) | Gets the inner height of the collections elements. |
| outerWidth | [<code>outerDimensionCallback</code>](#outerDimensionCallback) | Gets the outer width of the collections elements. |
| outerHeight | [<code>outerDimensionCallback</code>](#outerDimensionCallback) | Gets the outer height of the collections elements. |
| scrollWidth | [<code>dimensionCallback</code>](#dimensionCallback) | Gets the scroll width of the collections elements. |
| scrollHeight | [<code>dimensionCallback</code>](#dimensionCallback) | Gets the scroll height of the collections elements. |
| scrollTop | [<code>getOrSetValueCallback</code>](#getOrSetValueCallback) | Gets or sets the scrollTop of the collections elements. |
| scrollLeft | [<code>getOrSetValueCallback</code>](#getOrSetValueCallback) | Gets or sets the scrollLeft of the collections elements. |
| offset | [<code>offsetCallback</code>](#offsetCallback) | Gets or sets the collections elements offset. |
| animate | [<code>animateCallback</code>](#animateCallback) | Animates the given properties to the given values on the collections elements. |
| scrollTo | [<code>scrollToCallback</code>](#scrollToCallback) | Scrolls the collections elements to elements. |
...
| is | [<code>isCallback</code>](#isCallback) | Whether a property of an element of the collection is true or if an element of the collection is part of another set. |
| contains | [<code>elementsBooleanCallback</code>](#elementsBooleanCallback) | Whether the collections elements contain at least one of elements. |
...
## defaultCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
<a name="ajaxCompleteCallback"></a>

## ajaxCompleteCallback ⇒ <code>void</code>
**Kind**: global typedef  
**Returns**: <code>void</code> - void  

| Param | Type | Description |
| --- | --- | --- |
| [response] | <code>\*</code> | The requests response |
| [status] | <code>number</code> | The requests HTTP status code |
| [request] | <code>XMLHttpRequest</code> | The orginal XMLHttpRequest object |

<a name="xhrCallback"></a>

## xhrCallback ⇒ <code>XMLHttpRequest</code>
**Kind**: global typedef  
**Returns**: <code>XMLHttpRequest</code> - XMLHttpRequest  

| Param | Type | Description |
| --- | --- | --- |
| [request] | <code>XMLHttpRequest</code> | The orginal XMLHttpRequest object |

<a name="onStepCallback"></a>

## onStepCallback ⇒ <code>void</code>
**Kind**: global typedef  
**Returns**: <code>void</code> - void  

| Param | Type | Description |
| --- | --- | --- |
| percent | <code>number</code> | The eased percentage of the current time over the duration |

<a name="cssClassCallback"></a>

## cssClassCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  

| Param | Type | Description |
| --- | --- | --- |
| cssClasses | <code>string</code> | Space sepearated classes to supply to the function |

<a name="toggleCssClassCallback"></a>

## toggleCssClassCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="hasClassCallback"></a>

## hasClassCallback ⇒ <code>boolean</code>
**Kind**: global typedef  
**Returns**: <code>boolean</code> - Whether at least one of the collections elements has all of the provided classes  
...
<a name="cssCallback"></a>

## cssCallback ⇒ [<code>jLight</code>](#jLight) \| <code>string</code> \| <code>CSSStyleDeclaration</code>
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) \| <code>string</code> \| <code>CSSStyleDeclaration</code> - jLight collection, property value or elements CSSStyleDeclaration  
...
## visibilityCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
## toggleVisibilityCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
| Param | Type | Description |
| --- | --- | --- |
| [event] | <code>Event</code> | The dispatched event with jLight elements for the events currentTarget and target attached (event.$currentTarget and event.$target) |

<a name="onCallback"></a>

## onCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
## offCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="delegateCallback"></a>

## delegateCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
| --- | --- | --- |
| eventNames | <code>string</code> | Space separated list of event names |
| callback | <code>function</code> | The function to apply |

<a name="triggerCallback"></a>

## triggerCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="propCallback"></a>

## propCallback ⇒ [<code>jLight</code>](#jLight) \| <code>boolean</code>
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) \| <code>boolean</code> - jLight collection or if the property is set on at least one of the collections elements  
...
## removeAttrCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
## iteratorCallback ⇒ <code>void</code>
**Kind**: global typedef  
**Returns**: <code>void</code> - void  

| Param | Type | Description |
| --- | --- | --- |
| [$element] | [<code>jLight</code>](#jLight) | The current jLight element |
| [index] | <code>number</code> | The current index |

<a name="valCallback"></a>

## valCallback ⇒ [<code>jLight</code>](#jLight) \| <code>boolean</code> \| <code>string</code>
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) \| <code>boolean</code> \| <code>string</code> - jLight collection or the value  
...
## dataCallback ⇒ [<code>jLight</code>](#jLight) \| <code>\*</code>
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) \| <code>\*</code> - jLight collection  
...
<a name="cloneCallback"></a>

## cloneCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="elementsCallback"></a>

## elementsCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
## removeCallback ⇒ [<code>jLight</code>](#jLight) \| <code>null</code>
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) \| <code>null</code> - jLight collection or null  
...
## indexElementCallback ⇒ <code>HTMLElement</code> \| <code>undefined</code>
**Kind**: global typedef  
**Returns**: <code>HTMLElement</code> \| <code>undefined</code> - The element or null  
...
<a name="indexjLightCallback"></a>

## indexjLightCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
## selectorCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="elementsBooleanCallback"></a>

## elementsBooleanCallback ⇒ <code>boolean</code>
**Kind**: global typedef  
**Returns**: <code>boolean</code> - If the conditon is met  
...
## filterCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
## outerIteratorCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="sliceCallback"></a>

## sliceCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="spliceCallback"></a>

## spliceCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="arrayLengthCallback"></a>

## arrayLengthCallback ⇒ <code>number</code>
**Kind**: global typedef  
**Returns**: <code>number</code> - The collections new length  

| Param | Type | Description |
| --- | --- | --- |
| ...elements | [<code>jLight</code>](#jLight) \| <code>string</code> \| <code>HTMLElement</code> \| <code>HTMLCollection</code> \| <code>NodeList</code> | The elements to apply to the function. |

<a name="compareCallback"></a>

## compareCallback ⇒ <code>number</code>
**Kind**: global typedef  
**Returns**: <code>number</code> - The value to determine which place the element to compare will take  

| Param | Type | Description |
| --- | --- | --- |
| $element1 | [<code>jLight</code>](#jLight) | The element to compare |
| $element2 | [<code>jLight</code>](#jLight) | The element to compare to |

<a name="sortCallback"></a>

## sortCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="reduceInnerCallback"></a>

## reduceInnerCallback ⇒ <code>\*</code>
**Kind**: global typedef  
**Returns**: <code>\*</code> - The current reduction result  

| Param | Type | Description |
| --- | --- | --- |
| accumulator | <code>\*</code> | The accumulated value |
| $element | [<code>jLight</code>](#jLight) | The current element |
| [index] | <code>number</code> | The current elements index |
...
<a name="mapInnerCallback"></a>

## mapInnerCallback ⇒ [<code>jLight</code>](#jLight) \| <code>string</code> \| <code>HTMLElement</code> \| <code>HTMLCollection</code> \| <code>NodeList</code>
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) \| <code>string</code> \| <code>HTMLElement</code> \| <code>HTMLCollection</code> \| <code>NodeList</code> - The elements to map  
...
## mapCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="multipleElementsCallback"></a>

## multipleElementsCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  

| Param | Type | Description |
| --- | --- | --- |
| ...elements | [<code>jLight</code>](#jLight) \| <code>string</code> \| <code>HTMLElement</code> \| <code>HTMLCollection</code> \| <code>NodeList</code> \| <code>Array.&lt;(jLight\|string\|HTMLElement\|HTMLCollection\|NodeList)&gt;</code> | The elements to apply to the function. |

<a name="iteratorBooleanCallback"></a>

## iteratorBooleanCallback ⇒ <code>boolean</code>
**Kind**: global typedef  
**Returns**: <code>boolean</code> - Whether the condition is met  
...
<a name="arrayBooleanCallback"></a>

## arrayBooleanCallback ⇒ <code>boolean</code>
**Kind**: global typedef  
**Returns**: <code>boolean</code> - If the conditon is met  
...
<a name="elementsNumberCallback"></a>

## elementsNumberCallback ⇒ <code>number</code>
**Kind**: global typedef  
**Returns**: <code>number</code> - The resulting number  
...
<a name="getOrSetValueCallback"></a>

## getOrSetValueCallback ⇒ [<code>jLight</code>](#jLight) \| <code>number</code>
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) \| <code>number</code> - jLight collection or the value  
...
<a name="dimensionCallback"></a>

## dimensionCallback ⇒ <code>number</code>
**Kind**: global typedef  
**Returns**: <code>number</code> - The dimension value  
<a name="outerDimensionCallback"></a>

## outerDimensionCallback ⇒ <code>number</code>
**Kind**: global typedef  
**Returns**: <code>number</code> - The dimension value  
...
<a name="offsetCallback"></a>

## offsetCallback ⇒ [<code>jLight</code>](#jLight) \| <code>Object</code>
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) \| <code>Object</code> - jLight collection or elements offset  
...
## animateCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="scrollToCallback"></a>

## scrollToCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="animateOutCallback"></a>

## animateOutCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="fadeCallback"></a>

## fadeCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
## slideCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
## slideToggleCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
<a name="inViewCallback"></a>

## inViewCallback ⇒ [<code>jLight</code>](#jLight) \| <code>boolean</code>
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) \| <code>boolean</code> - jLight collection or whether the collections first element is in view  
...
<a name="delayCallback"></a>

## delayCallback ⇒ <code>Promise</code>
**Kind**: global typedef  
**Returns**: <code>Promise</code> - The corresponding promise  
...
<a name="whenCallback"></a>

## whenCallback ⇒ [<code>jLight</code>](#jLight)
**Kind**: global typedef  
**Returns**: [<code>jLight</code>](#jLight) - jLight collection  
...
## stringCallback ⇒ <code>string</code>
**Kind**: global typedef  
**Returns**: <code>string</code> - The resulting string  
<a name="stringObjectCallback"></a>

## stringObjectCallback ⇒ <code>Object.&lt;string, string&gt;</code>
**Kind**: global typedef  
**Returns**: <code>Object.&lt;string, string&gt;</code> - The resulting JSON object  
